...
import edicao2025_6 from "@/assets/edicao-2025/edicao-2025-6.jpg.asset.json";
...
import sergioGraffAsset from "@/assets/palestrantes/sergio-graff.jpg.asset.json";
const sergioGraff = sergioGraffAsset.url;
...
const parceirosMidia = [
  ...
  { name: "Tierra Fértil", src: tierraFertilLogo, href: "https://tierrafertil.com.mx/", imgClassName: "max-h-[75%] max-w-[75%]" },
];
      ...
      <section id="sobre" className="border-b border-border">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-px bg-border md:grid-cols-4">
          {[
            ...
            { icon: Users, label: "Público", value: "+1500 expositores e visitantes do Brasil, China, Índia, Europa, América Latina" },
      ...
      <section className="border-b border-border bg-background">
        <div className="mx-auto max-w-7xl px-6 py-16">
          ...
          <div className="mt-8 grid grid-cols-2 gap-2 md:grid-cols-3 md:gap-3">
            <img src={edicao2025_1.url} alt="Credenciamento do Brasil AgrochemShow 2025" className="aspect-[4/3] h-full w-full object-cover" loading="lazy" />
            ...
            <img src={edicao2025_6.url} alt="Palestra com público atento" className="aspect-[4/3] h-full w-full object-cover" loading="lazy" />
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-16 px-6 py-28 md:grid-cols-12">
          <div className="md:col-span-7">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              ...
              de 13 países, 1.000 participantes.
            </p>
            <Link
              to="/inscricao"
